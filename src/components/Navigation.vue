  ...
  <nav class="navbar" :class="{ 'scrolled': isScrolled }">
    <div class="container">
      ...
      <div class="navbar-nav">
        ...
        <a href="https://github.com/cMagic-Girl/" target="_blank" rel="noopener noreferrer" class="nav-link github-nav-link">
    ...
    <!-- Mobile Navigation Menu with Transition -->
      <transition name="slide">
        ...
        <a href="https://github.com/cMagic-Girl/" target="_blank" rel="noopener noreferrer" class="mobile-nav-link" @click="closeMobileMenu">
